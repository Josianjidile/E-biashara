...
<div class="container py-5">
        ...
        <label for="">Zip Code:</label>
          <div class="border">{{$orders->pincode}}</div>
               ...
               <td>
               <a href="{{asset('assets/uploads/products/'.$item->products->image)}}" width="50px"; alt="product image"></a>
               </td>
                </tr>
                @endforeach
                <thead>
            ...
            <div class="mt-5 px-2">
                ...
                <form action="{{ url('update-order/'.$orders->id)}}" method="POST">
                    ...
                    <select class="form-select" name="order_status">
                        ...
                        <option {{$orders->status == '1'? 'selected' :'' }} value="0">Completed</option>
                   </select>
