        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                  ...
                  <textarea class="form control" name="user_review" rows="5"  placeholder="wreite review"></textarea>
                  <button type="submit" class="btn btn-primary mt-3 ">Submit Review</button>
                     ...
                     <div class="alert alert-danger">
                        ...
                        <p>
                            For trustworthiness of reviews,only customers who purchased the product can write a review about the product.
                        </p>
