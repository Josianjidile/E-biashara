    ...
    <div class="star-icon">
      @if ($user_rating)
        ...
        <label for="rating{{$i}}" class="fa fa-star"></label>
                              @endfor
                              @for ($j=1; $j<= $user_ratjng->stars_rated; $j++)
   ...
   <div class="container pb-5">
               <div class="product_data">
                 <div class="">
                        ...
                        <div class="col-md-4 border-right">
                          ...
                          <div class="col-md-8">
                            <h2 class="mb-0">
                             ...
                             <hr>
                             <label class="me-3">Original Price: <s>Tsh  {{$products->original_price}} </s></label> 
                             <label class="fw-bold">Selling Price:Tsh {{$products->selling_price}}</label> 
                  ...
                  @if($products->qty > 0)
                  <label style="font-size: 16px" class="float-center badge bg-success">In stock</label>
                  @else
                  <label style="font-size: 16px" class="float-center badge bg-danger">Out of stock</label>
                  @endif
                  <div class="row mt-2">
                  <div class="col-md-2">
                    <input type="hidden" name="{{$products->id}}" class="prod_id">
